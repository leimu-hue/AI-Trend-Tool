...
- [x] 7.1 重写 `web/src/renderer/src/pages/Sources.tsx`：移除 antd Card，实现表格（名称、类型 badge、URL 截断 mono、间隔、文章数、上次抓取、状态 badge、操作按钮）、添加/编辑 Modal（名称 + 类型 + URL + 间隔字段）、手动抓取按钮、编辑 Modal 中删除按钮、删除确认
