...
Provide a dark-themed token authentication page where users enter an API token, validate it against the backend, and proceed to the dashboard on success.
