# Parser JoinSet Tracking

## Purpose

Track spawned fetch sub-tasks in the Parser module using `tokio::task::JoinSet`, ensuring all in-flight tasks complete before the Parser exits on graceful shutdown.
