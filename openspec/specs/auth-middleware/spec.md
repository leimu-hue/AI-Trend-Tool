...
Bearer token authentication middleware for the TrendAITool API. All routes under `/api/v1/*` require a valid, non-revoked, non-expired API token. The `/health` endpoint remains unauthenticated.
